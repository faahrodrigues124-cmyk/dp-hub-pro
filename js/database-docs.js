    ...
    },
    {
        ...
        conteudo: `
            <div class="space-y-5 text-xs leading-relaxed text-slate-300">
                ...
                <p>• <b>Fórmula DSR:</b> $(\text{Variáveis} \div \text{Dias Úteis}) \times \text{Domingos e Feriados}$. <br>• <b>Falta:</b> Desconta o dia e o DSR da semana correspondente (Art. 6º Lei 605/49).</p>
            </div>
        `
    },
    {
